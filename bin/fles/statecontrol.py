...
def state():
    ...
    chg_img = "".join(["data:image/png;base64,",
                      str(base64.b64encode(open("/tmp/upsdiagd/site/img/pastday_CHG.png",
                                                "rb").read()))[2:-1]]
                     )
    run_img = "".join(["data:image/png;base64,",
                     str(base64.b64encode(open("/tmp/upsdiagd/site/img/pastday_RUN.png",
                                               "rb").read()))[2:-1]]
                    )
    v_img = "".join(["data:image/png;base64,",
                     str(base64.b64encode(open("/tmp/upsdiagd/site/img/pastday_V.png",
                                               "rb").read()))[2:-1]]
                    )
