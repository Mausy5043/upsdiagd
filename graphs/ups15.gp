...
stats ifnameh using 9 name "Yh" nooutput
...
# stats to be calculated here for Y-axes
stats ifnamed using 9 name "Yd" nooutput
...
# stats for Y-axis
stats ifnamew using 9 name "Yw" nooutput
...
set multiplot layout 2, 3 title "Batterij lading ".strftime("( %Y-%m-%dT%H:%M:%S )", time(0)+utc_offset)
...
# ***** PLOT *****
plot ifnamey \
      using ($1+utc_offset):9 title " Lading [%]" with lines lw 0.1 lc rgb "#ccbb0000"
...
# ***** PLOT *****
plot ifnamed \
      using ($1+utc_offset):9 with lines lw 0.1 lc rgb "#ccbb0000"
      # with points pt 5 ps 0.2 fc rgb "#ccbb0000" \
